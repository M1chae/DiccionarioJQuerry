...
<head>
    ...
    <link rel="stylesheet" href="CSS/estilodic.CSS">
...
<body>
    ...
    <div class="barra1">
        <a class="activo" href="#"><i class="fa fa-bath"></i></a>
    ...
    <div class="autor">
        <div class="fot">
            <img src="IMG/me.png" alt="" width="20%">
        </div>
        <h1>
            Autor: Miguel Cuentas
        </h1>
    </div>
    </div>

    <div class="contenido">
        <div class="letra" id="a">
            <h1>A</h1>
        </div>
        <div class="elemento">
            <div class="foto">
                <img src="IMG/avion.png" alt="" width="80%">
                Avi&oacute;n
            </div>
            <div>
                Un avi&oacute;n, también denominado aeroplano, es un aerodino de ala fija, o aeronave con mayor densidad que el aire, dotado de alas y un espacio de carga, y capaz de volar impulsado por uno o más motores.
            </div>
        </div>

        <div class="elemento">
            <div class="foto">
                <img src="IMG/avestruz.png" alt="" width="80%">
                Avestruz</div>
            <div>
        ...
        <div class="elemento">
            <div class="foto">
                <img src="IMG/ardilla.png" alt="" width="80%">
                Ardilla</div>
            <div>
                Se llama ardilla a ciertas especies de roedores esciuromorfos de la familia Sciuridae, entre las que se encuentran: Las especies del género Ratufa, el único de la subfamilia Ratufinae.
            </div>
        </div>

        <div class="contenido">
            <div class="letra" id="b">
                <h1>B</h1>
            </div>
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/banco.png" alt="" width="80%">
                    Banco</div>
                <div>
                    Un banco, también conocido como entidad de crédito o entidad de depósito es una empresa financiera que acepta depósitos del público.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/balon.png" alt="" width="80%">
                    Bal&oacute;n</div>
                <div>
                    Un balón es una bola que suele utilizarse en diversos deportes y juegos. Suelen estar infladas con aire, por lo que son bastante livianas.
                </div>
            </div>
    
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/ballena.png" alt="" width="80%">
                    Ballena</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="c">
                <h1>C</h1>
            </div>
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/caballo.png" alt="" width="80%">
                    Caballo</div>
                <div>
                    El caballo ​​ es un mamífero perisodáctilo domesticado de la familia de los équidos. Es un herbívoro perisodáctilo de gran porte, y cuello largo y arqueado poblado por largas crines.
                </div>
            </div>
    
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/cabana.png" alt="" width="80%">
                    Cabaña</div>
                <div>
                    una cabaña es una vivienda sencilla, típicamente ubicada en áreas rurales o semirrurales. Originalmente en la Edad Media, las cabañas albergaron a trabajadores agrícolas y a sus familias.
                </div>
            </div>
        
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/caja.png" alt="" width="85%">
                    Caja</div>
                <div>
                    Las cajas de cartón son la solución más común para empaquetar, almacenar y enviar diferentes tipos de productos.
                </div>
            </div>   
            
        <div class="contenido">
            <div class="letra" id="d">
                <h1>D</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/dado.png" alt="" width="80%">
                    Dado</div>
                <div>
                    Un dado es un objeto preparado para mostrar un resultado aleatorio cuando es lanzado sobre una superficie horizontal, desde la mano o mediante un cubilete.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/dragon.png" alt="" width="80%">
                    Dragon</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/duende.png" alt="" width="80%">
                    Duende</div>
                <div>
        ...
        <div class="contenido">
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/erizo.png" alt="" width="80%">
                    Erizo</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/edificio.png" alt="" width="80%">
                    Edificio</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/espinaca.png" alt="" width="80%">
                    Espinaca</div>
                <div>
            ...
            <div class="letra" id="f">
                <h1>F</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/flamenco.png" alt="" width="80%">
                    Flamenco</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/frutilla.png" alt="" width="80%">
                    Frutilla</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/fuego.png" alt="" width="80%">
                    Fuego</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="g">
                <h1>G</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/grillo.png" alt="" width="80%">
                    Grillo</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/girasol.png" alt="" width="80%">
                    Girasol</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/galaxia.png" alt="" width="80%">
                    Galaxia</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="h">
                <h1>H</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/hamster.png" alt="" width="80%">
                    H&aacute;mster</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/haba.png" alt="" width="80%">
                    Haba</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/hada.png" alt="" width="80%">
                    Hada</div>
                <div>
        ...
        <div class="contenido">
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/infor.png" alt="" width="80%">
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/iglesia.png" alt="" width="80%">
                    Iglesia</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/insecticida.png" alt="" width="80%">
                    Insecticida</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="j">
                <h1>J</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/jabali.png" alt="" width="80%">
                    Jabal&iacute;</div>
                <div>
                    El jabal&iacute; es el primo salvaje del cerdo doméstico. Es un animal vigoroso, de cuerpo grueso y redondo, cabeza grande y alargada terminada en largo y estrecho hocico, la jeta. Tiene las orejas grandes, enhiestas y de forma triangular. El cuerpo del jabalí está cubierto de pelo.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/jacuzzi.png" alt="" width="80%">
                    Jacuzzi</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/jabon.png" alt="" width="80%">
                    Jab&oacute;n</div>
                <div>
                    Es un producto que sirve para la higiene personal y para lavar determinados objetos. En nuestros tiempos también es empleado para decorar el cuarto de baño. Se encuentra en pastilla, en polvo o en crema, es diferente entre lo que es un detergente y un champ&uacute;.
                </div>
        </div>


        <div class="contenido">
            <div class="letra" id="k">
                <h1>K</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/koala.png" alt="" width="80%">
                    Koala</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/kiwi.png" alt="" width="85%">
                    Kiwi</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/kimono.png" alt="" width="80%">
                    Kimono</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="l">
                <h1>L</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/lobo.png" alt="" width="80%">
                    Lobo</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/limon.png" alt="" width="80%">
                    Lim&oacute;n</div>
                <div>
                    El lim&oacute;n es el fruto en baya del limonero, &aacute;rbol de hoja perenne y espinoso de la familia de las rut&aacute;ceas. Este &aacute;rbol se desarrolla con &eacute;xito en los climas templados y tropicales, Seg&uacute;n su tamaño, los limones se pueden clasificar en: pequeños, medianos y grandes; y por su color en verdes y amarillos.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/ladrillo.png" alt="" width="80%">
                    Ladrillo</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="m">
                <h1>M</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/mamut.png" alt="" width="80%">
                    Mamut</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/mango.png" alt="" width="80%">
                    Mango</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/molino.png" alt="" width="80%">
                    Molino</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="n">
                <h1>N</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/nutria.png" alt="" width="80%">
                    Nutria;</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/nuez.png" alt="" width="80%">
                    Nuez</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/nido.png" alt="" width="80%">
                    Nido</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="ñ">
                <h1>Ñ</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/ñandu.jpg" alt="" width="80%">
                    Ñandu</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/ñu.png" alt="" width="87%">
                     Ñu</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/ñoño.png" alt="" width="80%">
                    Ñoño</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="o">
                <h1>O</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/orangutan.png" alt="" width="80%">
                    Orangut&aacute;n</div>
                <div>
                    El orangut&aacute;n es un g&eacute;nero de primates homínidos. Se distinguen de los simios africanos por el pelaje de color rojizo y una constitución más adaptada a la vida arbórea. Además, tienen el estilo de vida más solitario de todos los monos.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/oregano.png" alt="" width="80%">
                    Or&eacute;gano</div>
                <div>
                    El or&eacute;gano es uno de los clásicos de la dieta mediterránea, condimento estrella de muchos platos que se ha utilizado desde tiempos inmemoriales para dar sabor a los alimentos. Y aunque sea Italia y su pizza los que le han convertido en un imprescindible en cualquier cocina en todo el mundo.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/ola.png" alt="" width="80%">
                    Ola</div>
                <div>
                    Una ola es una ondulación de agua sobre la superficie del mar. Las olas viajan muchos kil&oacute;metros por la superficie del mar a velocidades muy variadas y generalmente mueren en las playas. Normalmente, las olas se forman por el viento.
                </div>
        </div>


        <div class="contenido">
            <div class="letra" id="p">
                <h1>P</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/panda.png" alt="" width="80%">
                    Panda</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/palmera.png" alt="" width="80%">
                    Palmera</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/patin.png" alt="" width="80%">
                    Pat&iacute;n</div>
                <div>
                    Un pat&iacute;n es un aparato que sirve para deslizarse sobre hielo o pavimento liso, posee una plancha que se engancha al calzado bajo la suela y lleva una especie de cuchilla o ruedas, según la superficie donde se vaya a deslizar.
                </div>
        </div>


        <div class="contenido">
            <div class="letra" id="q">
                <h1>Q</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/quinua.png" alt="" width="80%">
                    Quinoa</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/queso.png" alt="" width="80%">
                    Queso</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/quena.png" alt="" width="80%">
                    Quena</div>
                <div>
        ...
        <div class="contenido">
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/rinoceronte.png" alt="" width="80%">
                    Rinoceronte</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/ramo.png" alt="" width="80%">
                    Ramo</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/radar.png" alt="" width="80%">
                    Radar</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="s">
                <h1>S</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/serpiente.png" alt="" width="80%">
                    Serpiente</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/sandia.png" alt="" width="80%">
                    Sand&iacute;a</div>
                <div>
                    La sand&iacute;a es un fruto grande y de forma más o menos esférica que suele consumirse cruda como postre. Su pulpa es de color rojizo o amarillento y de sabor dulce. Resulta un alimento muy refrescante que aporta muy pocas calorías al organismo.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/silla.png" alt="" width="85%">
                    Silla</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="t">
                <h1>T</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/tiburon.png" alt="" width="80%">
                    Tibur&oacute;n</div>
                <div>
                    Pez marino carn&iacute;voro de esqueleto cartilaginoso, cuerpo alargado y esbelto, entre cinco y siete aberturas branquiales, una o dos aletas dorsales, una aleta caudal heterocerca, cabeza aplanada con la boca muy grande en su parte inferior, y dientes muy afilados.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/tomate.png" alt="" width="80%">
                    Palmera</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/tornillo.png" alt="" width="80%">
                    Pat&iacute;n</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="u">
                <h1>U</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/unicornio.png" alt="" width="80%">
                    Unicornio</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/uva.png" alt="" width="85%">
                    Uva</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/uña.png" alt="" width="85%">
                    Uña</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="v">
                <h1>V</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/vaca.png" alt="" width="80%">
                    Vaca</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/vino.png" alt="" width="85%">
                    Vino</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/vela.png" alt="" width="85%">
                    Vela</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="w">
                <h1>W</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/waffle.png" alt="" width="80%">
                    Waffle</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/wiskhy.png" alt="" width="80%">
                    Whisky</div>
                <div>
                    Wisky es una bebida alcoh&oacute;lica obtenida por la destilación de la malta fermentada de cereales como cebada, trigo, centeno y maíz, y su posterior añejamiento en barriles de madera, tradicionalmente de roble blanco.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/wifi.png" alt="" width="85%">
                    Wi-Fi</div>
                <div>
                    Wi-Fi es la tecnología m&oacute;vil que se usa para conectar computadoras, tablets, smartphones y otros dispositivos a Internet. Wi-Fi es la señal de radio que se envía desde un enrutador inalámbrico a un dispositivo cercano.
                </div>
        </div>


        <div class="contenido">
            <div class="letra" id="x">
                <h1>X</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/xilofono.png" alt="" width="80%">
                    Xilofono</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/ximena.png" alt="" width="80%">
                    Ximena</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/xiaomi.png" alt="" width="80%">
                    Xiaomi</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="y">
                <h1>Y</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/yoyo.png" alt="" width="85%">
                    Yo-yo</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/yate.png" alt="" width="85%">
                    Yate</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/yunque.png" alt="" width="85%">
                    Yunque</div>
                <div>
        ...
        <div class="contenido">
            <div class="letra" id="z">
                <h1>Z</h1>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/zorro.png" alt="" width="80%">
                    Zorro</div>
                <div>
                    Mamífero c&aacute;nido de tamaño mediano, cuerpo esbelto, patas robustas y algo cortas, orejas erguidas, hocico alargado y puntiagudo, cola larga con pelo abundante y largo, y pelaje de color rojizo; es un astuto depredador; hay distintas especies que habitan en bosques de casi todo el mundo; su piel es muy apreciada en peletería.
                </div>
            </div>

            <div class="elemento">
                <div class="foto">
                    <img src="IMG/zanahoria.png" alt="" width="80%">
                    Zanahoria</div>
                <div>
            ...
            <div class="elemento">
                <div class="foto">
                    <img src="IMG/zafiro.png" alt="" width="80%">
                    Zafiro</div>
                <div>
